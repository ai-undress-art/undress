        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="bg-black/30 border border-white/10 rounded-xl p-8 backdrop-blur-sm">
            <div className="text-center">
              ...
              <div className="bg-gradient-to-r from-seductive-purple/20 to-seductive-pink/20 border border-seductive-purple/30 rounded-lg p-6 min-h-[120px] flex items-center justify-center">
